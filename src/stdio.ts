...
export async function main(): Promise<void> {
  // The kind registry does not populate itself in a bare process. Without this
  // every tool answers correctly about a vocabulary of nothing — which reads as
  // "this host has no nodes" rather than as a missing call.
